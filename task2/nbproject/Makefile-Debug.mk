...
${OBJECTDIR}/src/figures/colors.o: src/figures/colors.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -std=c++11 -lGLEW -lglfw -lGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/figures/colors.o src/figures/colors.cpp

${OBJECTDIR}/src/figures/geom.o: src/figures/geom.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/figures
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -std=c++11 -lGLEW -lglfw -lGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/figures/geom.o src/figures/geom.cpp
