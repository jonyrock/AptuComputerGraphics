...
${OBJECTDIR}/src/camera.o: src/camera.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -I/usr/include/ImageMagick -std=c++11 -lGLEW -lglfw -lGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/camera.o src/camera.cpp

${OBJECTDIR}/src/figures/geom.o: src/figures/geom.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/figures
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -I/usr/include/ImageMagick -std=c++11 -lGLEW -lglfw -lGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/figures/geom.o src/figures/geom.cpp

${OBJECTDIR}/src/figures/textures.o: src/figures/textures.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/figures
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -I/usr/include/ImageMagick -std=c++11 -lGLEW -lglfw -lGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/figures/textures.o src/figures/textures.cpp
...
${OBJECTDIR}/src/texture.o: src/texture.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -I/usr/include/ImageMagick -std=c++11 -lGLEW -lglfw -lGL -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/texture.o src/texture.cpp
